...
The plugin connects to `https://curator.vumbualabs.com/mcp`. Configure Auth0 as the authorization server for that resource and grant the three scopes declared in the plugin.
