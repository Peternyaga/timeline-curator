...
The plugin does not contain a crawler or an OpenAI API integration. The Codex task performs broad, topic-appropriate research with its available tools and submits only validated cluster, source, media-reference, and feedback-choice metadata to Timeline.
